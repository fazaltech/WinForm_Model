...
namespace WinForm_Model
{
    class SQLiteDatabase
    {
        ...
        public static void InsertForm(form_data forms_data)
        {
            ...
            using (con)
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("cr14", forms_data.cr12);
                    cmd.Parameters.AddWithValue("cr15", forms_data.cr12);
        ...
        public static void InsertServer(List<form_data> forms_data)
        {
            ...
            using (con)
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    {
                        cmd.Parameters.Clear();
                        cmd.Parameters.AddWithValue("cr10", forms_data[i].cr10);
                        cmd.Parameters.AddWithValue("cr11", forms_data[i].cr11);
                        cmd.Parameters.AddWithValue("cr12", forms_data[i].cr12);
                        cmd.Parameters.AddWithValue("cr13m", forms_data[i].cr12);
                        cmd.Parameters.AddWithValue("cr13f", forms_data[i].cr12);
                        cmd.Parameters.AddWithValue("cr14", forms_data[i].cr12);
                        cmd.Parameters.AddWithValue("cr15", forms_data[i].cr12);
                        cmd.Parameters.AddWithValue("cr16", forms_data[i].cr16);
                        cmd.Parameters.AddWithValue("cr21", forms_data[i].cr21);
                        cmd.Parameters.AddWithValue("cr22", forms_data[i].cr22);
                        cmd.Parameters.AddWithValue("cr23", forms_data[i].cr23);
                        cmd.Parameters.AddWithValue("cr17a", forms_data[i].cr17a);
                        cmd.Parameters.AddWithValue("cr17b", forms_data[i].cr17b);
                        cmd.Parameters.AddWithValue("cr18a", forms_data[i].cr18a);
                        cmd.Parameters.AddWithValue("cr18b", forms_data[i].cr18b);
                        cmd.Parameters.AddWithValue("cr19a", forms_data[i].cr19a);
                        cmd.Parameters.AddWithValue("cr19b", forms_data[i].cr19b);
                        cmd.Parameters.AddWithValue("cr20a", forms_data[i].cr20a);
                        cmd.Parameters.AddWithValue("cr20b", forms_data[i].cr20b);
                        cmd.Parameters.AddWithValue("cr24a", forms_data[i].cr24a);
                        cmd.Parameters.AddWithValue("cr24b", forms_data[i].cr24b);
                        cmd.Parameters.AddWithValue("cr24c", forms_data[i].cr24c);
                        cmd.Parameters.AddWithValue("cr24d", forms_data[i].cr24d);
                        cmd.Parameters.AddWithValue("cr24e", forms_data[i].cr24e);
                        cmd.Parameters.AddWithValue("cr24f", forms_data[i].cr24f);
                        cmd.Parameters.AddWithValue("cr25a", forms_data[i].cr25a);
                        cmd.Parameters.AddWithValue("cr25b", forms_data[i].cr25b);
                        cmd.Parameters.AddWithValue("cr25c", forms_data[i].cr25c);
                        cmd.Parameters.AddWithValue("cr26a", forms_data[i].cr26a);
                        cmd.Parameters.AddWithValue("cr26b", forms_data[i].cr26b);
                        cmd.Parameters.AddWithValue("cr26c", forms_data[i].cr26c);
                        cmd.Parameters.AddWithValue("cr26d", forms_data[i].cr26d);
                        cmd.Parameters.AddWithValue("cr27a", forms_data[i].cr27a);
                        cmd.Parameters.AddWithValue("cr27b", forms_data[i].cr27b);
                        cmd.Parameters.AddWithValue("cr27c", forms_data[i].cr27c);
                        cmd.Parameters.AddWithValue("cr28a01", forms_data[i].cr28a01);
                        cmd.Parameters.AddWithValue("cr28a02", forms_data[i].cr28a02);
                        cmd.Parameters.AddWithValue("cr28b01", forms_data[i].cr28b01);
                        cmd.Parameters.AddWithValue("cr28b02", forms_data[i].cr28b02);
                        cmd.Parameters.AddWithValue("cr28c01", forms_data[i].cr28c01);
                        cmd.Parameters.AddWithValue("cr28c02", forms_data[i].cr28c02);
                        cmd.Parameters.AddWithValue("cr28d01", forms_data[i].cr28d01);
                        cmd.Parameters.AddWithValue("cr28d02", forms_data[i].cr28d02);
                        cmd.Parameters.AddWithValue("cr28e01", forms_data[i].cr28e01);
                        cmd.Parameters.AddWithValue("cr28e02", forms_data[i].cr28e02);
                        cmd.Parameters.AddWithValue("cr28f01", forms_data[i].cr28f01);
                        cmd.Parameters.AddWithValue("cr28f02", forms_data[i].cr28f02);
                        cmd.Parameters.AddWithValue("cr28fx01", forms_data[i].cr28fx01);
                        cmd.Parameters.AddWithValue("cr28fx02", forms_data[i].cr28fx02);
                        cmd.Parameters.AddWithValue("cr28fx98", forms_data[i].cr28fx98);
